"use strict";
! function(e) { "object" == typeof module && "object" == typeof module.exports ? e(require("jquery"), window, document) : e(jQuery, window, document) }(function(v, p, f, e) {
    var t = function(e, t) { this.$chartContainer = v(e), this.opts = t, this.defaultOptions = { nodeTitle: "name", nodeId: "id", toggleSiblingsResp: !1, visibleLevel: 999, chartClass: "", exportButton: !1, exportFilename: "OrgChart", exportFileextension: "png", parentNodeSymbol: "fa-users", draggable: !1, direction: "t2b", pan: !1, zoom: !1, zoominLimit: 7, zoomoutLimit: .5 } };
    t.prototype = {
        init: function(e) {
            var n = this;
            ...
            var i = this.options.data,
                s = this.$chart = v("<div>", { data: { options: this.options }, class: "orgchart" + ("" !== this.options.chartClass ? " " + this.options.chartClass : "") + ("t2b" !== this.options.direction ? " " + this.options.direction : ""), click: function(e) { v(e.target).closest(".node").length || s.find(".node.focused").removeClass("focused") } });
        ...
        attachExportButton: function() {
            var t = this,
                e = v("<button>", { class: "oc-export-btn" + ("" !== this.options.chartClass ? " " + this.options.chartClass : ""), text: "Export", click: function(e) { e.preventDefault(), t.export() } });
        ...
        panStartHandler: function(e) {
            ...
            if (v(e.target).closest(".node").length || e.touches && 1 < e.touches.length) a.data("panning", !1);
                ...
                var t = 0,
                    i = 0,
                    n = a.css("transform");
                if ("none" !== n) { var s = n.split(","); - 1 === n.indexOf("3d") ? (t = parseInt(s[4]), i = parseInt(s[5])) : (t = parseInt(s[12]), i = parseInt(s[13])) }
                var o = 0,
                    d = 0;
                if (e.targetTouches) {
        ...
        bindPan: function() { this.$chartContainer.css("overflow", "hidden"), this.$chart.on("mousedown touchstart", this.panStartHandler), v(f).on("mouseup touchend", { chart: this.$chart }, this.panEndHandler) },
        unbindPan: function() { this.$chartContainer.css("overflow", "auto"), this.$chart.off("mousedown touchstart", this.panStartHandler), v(f).off("mouseup touchend", this.panEndHandler) },
        ...
        bindZoom: function() { this.$chartContainer.on("wheel", { oc: this }, this.zoomWheelHandler), this.$chartContainer.on("touchstart", { oc: this }, this.zoomStartHandler), v(f).on("touchmove", { oc: this }, this.zoomingHandler), v(f).on("touchend", { oc: this }, this.zoomEndHandler) },
        unbindZoom: function() { this.$chartContainer.off("wheel", this.zoomWheelHandler), this.$chartContainer.off("touchstart", this.zoomStartHandler), v(f).off("touchmove", this.zoomingHandler), v(f).off("touchend", this.zoomEndHandler) },
        ...
        buildJsonDS: function(e) {
            ...
            return v.each(e.data(), function(e, t) { i[e] = t }), e.children("ul").children().each(function() { i.children || (i.children = []), i.children.push(t.buildJsonDS(v(this))) }), i
        },
        ...
        loopChart: function(e) {
            ...
            return i.siblings(":last").children().each(function() { n.children || (n.children = []), n.children.push(t.loopChart(v(this))) }), n
        },
        ...
        getNodeState: function(e, t) { var i = {}; if ("parent" === (t = t || "self")) { if ((i = e.closest(".nodes").siblings(":first")).length) return i.is(".hidden") || !i.is(".hidden") && i.closest(".nodes").is(".hidden") ? { exist: !0, visible: !1 } : { exist: !0, visible: !0 } } else if ("children" === t) { if ((i = e.closest("tr").siblings(":last")).length) return i.is(".hidden") ? { exist: !0, visible: !1 } : { exist: !0, visible: !0 } } else if ("siblings" === t) { if ((i = e.closest("table").parent().siblings()).length) return i.is(".hidden") || i.parent().is(".hidden") ? { exist: !0, visible: !1 } : { exist: !0, visible: !0 } } else if ((i = e).length) return i.closest(".nodes").length && i.closest(".nodes").is(".hidden") || i.closest("table").parent().length && i.closest("table").parent().is(".hidden") || i.parent().is("li") && (i.closest("ul").is(".hidden") || i.closest("verticalNodes").is(".hidden")) ? { exist: !0, visible: !1 } : { exist: !0, visible: !0 }; return { exist: !1, visible: !1 } },
        getRelatedNodes: function(e, t) { return e && e instanceof v && e.is(".node") ? "parent" === t ? e.closest(".nodes").parent().children(":first").find(".node") : "children" === t ? e.closest("tr").siblings(".nodes").children().find(".node:first") : "siblings" === t ? e.closest("table").parent().siblings().find(".node:first") : v() : v() },
        hideParentEnd: function(e) { v(e.target).removeClass("sliding"), e.data.upperLevel.addClass("hidden").slice(1).removeAttr("style") },
        ...
        isVisibleNode: function(e, t) { return this.getNodeState(v(t)).visible },
        ...
        showRelatedParentEnd: function(e) { v(e.target).removeClass("sliding") },
        ...
        startLoading: function(e) { var t = this.$chart; return (void 0 === t.data("inAjax") || !0 !== t.data("inAjax")) && (e.addClass("hidden"), e.parent().append('<i class="fa fa-circle-o-notch fa-spin spinner"></i>').children().not(".spinner").css("opacity", .2), t.data("inAjax", !0), v(".oc-export-btn" + ("" !== this.options.chartClass ? "." + this.options.chartClass : "")).prop("disabled", !0), !0) },
        ...
        nodeClickHandler: function(e) { this.$chart.find(".focused").removeClass("focused"), v(e.delegateTarget).addClass("focused") },
        loadNodes: function(t, e, i) {
            var n = this;
            this.options;
            v.ajax({ url: e, dataType: "json" }).done(function(e) { n.$chart.data("inAjax") && ("parent" === t ? v.isEmptyObject(e) || n.addParent(i.parent(), e) : "children" === t ? e.children.length && n.addChildren(i.parent(), e[t]) : n.addSiblings(i.parent(), e.siblings ? e.siblings : e)) }).fail(function() { console.log("Failed to get " + t + " data") }).always(function() { n.endLoading(i) })
        },
        ...
        filterAllowedDropNodes: function(i) {
            ...
            this.$chart.data("dragged", i).find(".node").each(function(e, t) {-1 === a.index(t) && (n.dropCriteria ? n.dropCriteria(i, s, v(t)) && v(t).addClass("allowedDrop") : v(t).addClass("allowedDrop")) })
        },
        dragstartHandler: function(e) { e.originalEvent.dataTransfer.setData("text/html", "hack for firefox"), "none" !== this.$chart.css("transform") && this.createGhostNode(e), this.filterAllowedDropNodes(v(e.target)) },
        dragoverHandler: function(e) { e.preventDefault(), v(e.delegateTarget).is(".allowedDrop") || (e.originalEvent.dataTransfer.dropEffect = "none") },
        ...
        createNode: function(i) {
            var e = this.options,
                t = i.level;
            i.children && v.each(i.children, function(e, t) { t.parentId = i.id });
        ...
        export: function(r, l) {
            ...
            html2canvas(t, {
                ...
                onclone: function(e) { v(e).find(".canvasContainer").css("overflow", "visible").find('.orgchart:not(".hidden"):first').css("transform", "") },
            ...
            }).then(function() { c.removeClass("canvasContainer") }, function() { c.removeClass("canvasContainer") })
        }
    }, v.fn.orgchart = function(e) { return new t(this, e).init() }
});
